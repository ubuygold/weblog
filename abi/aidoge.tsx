const AidogeABI = [
  {
    inputs: [
      { internalType: "contract IERC20", name: "_backToken", type: "address" },
  ...
  },
  {
    inputs: [],
    name: "jackpotWallet",
    outputs: [{ internalType: "contract IJackpot", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_gov1Fee", type: "uint256" },
      { internalType: "uint256", name: "_gov2Fee", type: "uint256" },
      { internalType: "uint256", name: "_liquidityFee", type: "uint256" },
      { internalType: "uint256", name: "_jackpotFee", type: "uint256" },
      { internalType: "uint256", name: "_bonusFee", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "address", name: "_gov1Wallet", type: "address" },
      { internalType: "address", name: "_gov2Wallet", type: "address" },
      { internalType: "address", name: "_bonusWallet", type: "address" },
      { internalType: "address", name: "_jackpotWallet", type: "address" },
